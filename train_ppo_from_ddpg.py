...
if __name__ == '__main__':
    ...
    parser.add_argument('--method', type=str, default='ppo', help='Choose Algorithm to solve [`ddpg`,`dqn`]')
...
#        model.reset(sigma)
        ...
        while True:
            ...
            current_knob = generate_knob(action, 'ppo')
            logger.info("[ppo] Action: {}".format(action))
